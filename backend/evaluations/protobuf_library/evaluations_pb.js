...
goog.exportSymbol('proto.runtimePackage.FailedTestStats', null, global);
...
goog.exportSymbol('proto.runtimePackage.GetFailedTestsStatsRequest', null, global);
goog.exportSymbol('proto.runtimePackage.GetFailedTestsStatsResponse', null, global);
goog.exportSymbol('proto.runtimePackage.GetIntermediateCyclesRequest', null, global);
goog.exportSymbol('proto.runtimePackage.GetIntermediateCyclesResponse', null, global);
 ...
 * @constructor
 */
proto.runtimePackage.GetFailedTestsStatsRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.runtimePackage.GetFailedTestsStatsRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.runtimePackage.GetFailedTestsStatsRequest.displayName = 'proto.runtimePackage.GetFailedTestsStatsRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.runtimePackage.GetFailedTestsStatsResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.runtimePackage.GetFailedTestsStatsResponse.repeatedFields_, null);
};
goog.inherits(proto.runtimePackage.GetFailedTestsStatsResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.runtimePackage.GetFailedTestsStatsResponse.displayName = 'proto.runtimePackage.GetFailedTestsStatsResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.runtimePackage.FailedTestStats = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.runtimePackage.FailedTestStats.repeatedFields_, null);
};
goog.inherits(proto.runtimePackage.FailedTestStats, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.runtimePackage.FailedTestStats.displayName = 'proto.runtimePackage.FailedTestStats';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.runtimePackage.GetIntermediateCyclesRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.runtimePackage.GetIntermediateCyclesRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.runtimePackage.GetIntermediateCyclesRequest.displayName = 'proto.runtimePackage.GetIntermediateCyclesRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.runtimePackage.GetIntermediateCyclesResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.runtimePackage.GetIntermediateCyclesResponse.repeatedFields_, null);
};
goog.inherits(proto.runtimePackage.GetIntermediateCyclesResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.runtimePackage.GetIntermediateCyclesResponse.displayName = 'proto.runtimePackage.GetIntermediateCyclesResponse';
}
...
webpageSizeKb: jspb.Message.getFloatingPointFieldWithDefault(msg, 15, 0.0)
  };
...
/**
 * optional float webpage_size_kb = 15;
 * @return {number}
 */
proto.runtimePackage.AddEvaluationRequest.prototype.getWebpageSizeKb = function() {
 ...
 * @return {!proto.runtimePackage.AddEvaluationRequest} returns this
 */
proto.runtimePackage.AddEvaluationRequest.prototype.setWebpageSizeKb = function(value) {
...
needsAuthentication: jspb.Message.getBooleanFieldWithDefault(msg, 3, false),
numElements: jspb.Message.getFieldWithDefault(msg, 4, 0),
pageSizeKb: jspb.Message.getFloatingPointFieldWithDefault(msg, 5, 0.0)
  };
...
/**
 * optional int32 num_elements = 4;
 * @return {number}
 */
proto.runtimePackage.Webpage.prototype.getNumElements = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 4, 0));
};
 ...
 * @return {!proto.runtimePackage.Webpage} returns this
 */
proto.runtimePackage.Webpage.prototype.setNumElements = function(value) {
  return jspb.Message.setProto3IntField(this, 4, value);
};


/**
 * optional float page_size_kb = 5;
 * @return {number}
 */
proto.runtimePackage.Webpage.prototype.getPageSizeKb = function() {
  return /** @type {number} */ (jspb.Message.getFloatingPointFieldWithDefault(this, 5, 0.0));
};
 ...
 * @return {!proto.runtimePackage.Webpage} returns this
 */
proto.runtimePackage.Webpage.prototype.setPageSizeKb = function(value) {
  return jspb.Message.setProto3FloatField(this, 5, value);
};
...
passedInstances: jspb.Message.getFieldWithDefault(msg, 4, 0),
applicableInstances: jspb.Message.getFieldWithDefault(msg, 5, 0)
  };
...
proto.runtimePackage.GetWebpageComparisonDataResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 4:
      var value = /** @type {number} */ (reader.readInt32());
      msg.setPassedInstances(value);
      break;
    case 5:
      var value = /** @type {number} */ (reader.readInt32());
      msg.setApplicableInstances(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.runtimePackage.GetWebpageComparisonDataResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getApplicableInstances();
  if (f !== 0) {
    writer.writeInt32(
      5,
      f
...
/**
 * optional int32 passed_instances = 4;
 * @return {number}
 */
proto.runtimePackage.GetWebpageComparisonDataResponse.prototype.getPassedInstances = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 4, 0));
};
 ...
 * @return {!proto.runtimePackage.GetWebpageComparisonDataResponse} returns this
 */
proto.runtimePackage.GetWebpageComparisonDataResponse.prototype.setPassedInstances = function(value) {
  return jspb.Message.setProto3IntField(this, 4, value);
};


/**
 * optional int32 applicable_instances = 5;
 * @return {number}
 */
proto.runtimePackage.GetWebpageComparisonDataResponse.prototype.getApplicableInstances = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 5, 0));
};
 ...
 * @return {!proto.runtimePackage.GetWebpageComparisonDataResponse} returns this
 */
proto.runtimePackage.GetWebpageComparisonDataResponse.prototype.setApplicableInstances = function(value) {
  return jspb.Message.setProto3IntField(this, 5, value);
};
 ...
 * @return {!Object}
 */
proto.runtimePackage.GetFailedTestsStatsRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.runtimePackage.GetFailedTestsStatsRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.runtimePackage.GetFailedTestsStatsRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.runtimePackage.GetFailedTestsStatsRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
cycleId: jspb.Message.getFieldWithDefault(msg, 1, 0)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.runtimePackage.GetFailedTestsStatsRequest}
 */
proto.runtimePackage.GetFailedTestsStatsRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.runtimePackage.GetFailedTestsStatsRequest;
  return proto.runtimePackage.GetFailedTestsStatsRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.runtimePackage.GetFailedTestsStatsRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.runtimePackage.GetFailedTestsStatsRequest}
 */
proto.runtimePackage.GetFailedTestsStatsRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.runtimePackage.GetFailedTestsStatsRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.runtimePackage.GetFailedTestsStatsRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.runtimePackage.GetFailedTestsStatsRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.runtimePackage.GetFailedTestsStatsRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getCycleId();
  if (f !== 0) {
    writer.writeInt32(
 ...
 * @return {number}
 */
proto.runtimePackage.GetFailedTestsStatsRequest.prototype.getCycleId = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.runtimePackage.GetFailedTestsStatsRequest} returns this
 */
proto.runtimePackage.GetFailedTestsStatsRequest.prototype.setCycleId = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @const
 */
proto.runtimePackage.GetFailedTestsStatsResponse.repeatedFields_ = [2];
 ...
 * @return {!Object}
 */
proto.runtimePackage.GetFailedTestsStatsResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.runtimePackage.GetFailedTestsStatsResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.runtimePackage.GetFailedTestsStatsResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.runtimePackage.GetFailedTestsStatsResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
statusCode: jspb.Message.getFieldWithDefault(msg, 1, 0),
failedTestsList: jspb.Message.toObjectList(msg.getFailedTestsList(),
    proto.runtimePackage.FailedTestStats.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.runtimePackage.GetFailedTestsStatsResponse}
 */
proto.runtimePackage.GetFailedTestsStatsResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.runtimePackage.GetFailedTestsStatsResponse;
  return proto.runtimePackage.GetFailedTestsStatsResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.runtimePackage.GetFailedTestsStatsResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.runtimePackage.GetFailedTestsStatsResponse}
 */
proto.runtimePackage.GetFailedTestsStatsResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new proto.runtimePackage.FailedTestStats;
      reader.readMessage(value,proto.runtimePackage.FailedTestStats.deserializeBinaryFromReader);
 ...
 * @return {!Uint8Array}
 */
proto.runtimePackage.GetFailedTestsStatsResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.runtimePackage.GetFailedTestsStatsResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.runtimePackage.GetFailedTestsStatsResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.runtimePackage.GetFailedTestsStatsResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getStatusCode();
  if (f !== 0) {
    writer.writeInt32(
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      proto.runtimePackage.FailedTestStats.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {number}
 */
proto.runtimePackage.GetFailedTestsStatsResponse.prototype.getStatusCode = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.runtimePackage.GetFailedTestsStatsResponse} returns this
 */
proto.runtimePackage.GetFailedTestsStatsResponse.prototype.setStatusCode = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};


/**
 * repeated FailedTestStats failed_tests = 2;
 * @return {!Array<!proto.runtimePackage.FailedTestStats>}
 */
proto.runtimePackage.GetFailedTestsStatsResponse.prototype.getFailedTestsList = function() {
  return /** @type{!Array<!proto.runtimePackage.FailedTestStats>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.runtimePackage.FailedTestStats, 2));
};


/**
 * @param {!Array<!proto.runtimePackage.FailedTestStats>} value
 * @return {!proto.runtimePackage.GetFailedTestsStatsResponse} returns this
*/
proto.runtimePackage.GetFailedTestsStatsResponse.prototype.setFailedTestsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 2, value);
};


/**
 * @param {!proto.runtimePackage.FailedTestStats=} opt_value
 * @param {number=} opt_index
 * @return {!proto.runtimePackage.FailedTestStats}
 */
proto.runtimePackage.GetFailedTestsStatsResponse.prototype.addFailedTests = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.runtimePackage.FailedTestStats, opt_index);
};
 ...
 * @return {!proto.runtimePackage.GetFailedTestsStatsResponse} returns this
 */
proto.runtimePackage.GetFailedTestsStatsResponse.prototype.clearFailedTestsList = function() {
 ...
 * @const
 */
proto.runtimePackage.FailedTestStats.repeatedFields_ = [3];
 ...
 * @return {!Object}
 */
proto.runtimePackage.FailedTestStats.prototype.toObject = function(opt_includeInstance) {
  return proto.runtimePackage.FailedTestStats.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.runtimePackage.FailedTestStats} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.runtimePackage.FailedTestStats.toObject = function(includeInstance, msg) {
  var f, obj = {
assertionName: jspb.Message.getFieldWithDefault(msg, 1, ""),
assertionCode: jspb.Message.getFieldWithDefault(msg, 2, ""),
webpagesList: (f = jspb.Message.getRepeatedField(msg, 3)) == null ? undefined : f
  };
 ...
 * @return {!proto.runtimePackage.FailedTestStats}
 */
proto.runtimePackage.FailedTestStats.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.runtimePackage.FailedTestStats;
  return proto.runtimePackage.FailedTestStats.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.runtimePackage.FailedTestStats} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.runtimePackage.FailedTestStats}
 */
proto.runtimePackage.FailedTestStats.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.runtimePackage.FailedTestStats.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.runtimePackage.FailedTestStats.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.runtimePackage.FailedTestStats} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.runtimePackage.FailedTestStats.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getAssertionName();
  if (f.length > 0) {
    writer.writeString(
...
/**
 * optional string assertion_name = 1;
 * @return {string}
 */
proto.runtimePackage.FailedTestStats.prototype.getAssertionName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.runtimePackage.FailedTestStats} returns this
 */
proto.runtimePackage.FailedTestStats.prototype.setAssertionName = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};


/**
 * optional string assertion_code = 2;
 * @return {string}
 */
proto.runtimePackage.FailedTestStats.prototype.getAssertionCode = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.runtimePackage.FailedTestStats} returns this
 */
proto.runtimePackage.FailedTestStats.prototype.setAssertionCode = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};


/**
 * repeated string webpages = 3;
 * @return {!Array<string>}
 */
proto.runtimePackage.FailedTestStats.prototype.getWebpagesList = function() {
  return /** @type {!Array<string>} */ (jspb.Message.getRepeatedField(this, 3));
};
 ...
 * @return {!proto.runtimePackage.FailedTestStats} returns this
 */
proto.runtimePackage.FailedTestStats.prototype.setWebpagesList = function(value) {
  return jspb.Message.setField(this, 3, value || []);
};
 ...
 * @return {!proto.runtimePackage.FailedTestStats} returns this
 */
proto.runtimePackage.FailedTestStats.prototype.addWebpages = function(value, opt_index) {
  return jspb.Message.addToRepeatedField(this, 3, value, opt_index);
};
 ...
 * @return {!proto.runtimePackage.FailedTestStats} returns this
 */
proto.runtimePackage.FailedTestStats.prototype.clearWebpagesList = function() {
  return this.setWebpagesList([]);
};
 ...
 * @return {!Object}
 */
proto.runtimePackage.GetIntermediateCyclesRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.runtimePackage.GetIntermediateCyclesRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.runtimePackage.GetIntermediateCyclesRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.runtimePackage.GetIntermediateCyclesRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
firstCycleId: jspb.Message.getFieldWithDefault(msg, 1, 0),
secondCycleId: jspb.Message.getFieldWithDefault(msg, 2, 0)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.runtimePackage.GetIntermediateCyclesRequest}
 */
proto.runtimePackage.GetIntermediateCyclesRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.runtimePackage.GetIntermediateCyclesRequest;
  return proto.runtimePackage.GetIntermediateCyclesRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.runtimePackage.GetIntermediateCyclesRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.runtimePackage.GetIntermediateCyclesRequest}
 */
proto.runtimePackage.GetIntermediateCyclesRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 1:
      var value = /** @type {number} */ (reader.readInt32());
      msg.setFirstCycleId(value);
      break;
    case 2:
      var value = /** @type {number} */ (reader.readInt32());
      msg.setSecondCycleId(value);
      break;
    default:
      reader.skipField();
      break;
 ...
 * @return {!Uint8Array}
 */
proto.runtimePackage.GetIntermediateCyclesRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.runtimePackage.GetIntermediateCyclesRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.runtimePackage.GetIntermediateCyclesRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.runtimePackage.GetIntermediateCyclesRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getFirstCycleId();
  if (f !== 0) {
    writer.writeInt32(
      1,
      f
...
/**
 * optional int32 first_cycle_id = 1;
 * @return {number}
 */
proto.runtimePackage.GetIntermediateCyclesRequest.prototype.getFirstCycleId = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.runtimePackage.GetIntermediateCyclesRequest} returns this
 */
proto.runtimePackage.GetIntermediateCyclesRequest.prototype.setFirstCycleId = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};


/**
 * optional int32 second_cycle_id = 2;
 * @return {number}
 */
proto.runtimePackage.GetIntermediateCyclesRequest.prototype.getSecondCycleId = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.runtimePackage.GetIntermediateCyclesRequest} returns this
 */
proto.runtimePackage.GetIntermediateCyclesRequest.prototype.setSecondCycleId = function(value) {
  return jspb.Message.setProto3IntField(this, 2, value);
};
 ...
 * @const
 */
proto.runtimePackage.GetIntermediateCyclesResponse.repeatedFields_ = [2];
 ...
 * @return {!Object}
 */
proto.runtimePackage.GetIntermediateCyclesResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.runtimePackage.GetIntermediateCyclesResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.runtimePackage.GetIntermediateCyclesResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.runtimePackage.GetIntermediateCyclesResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
statusCode: jspb.Message.getFieldWithDefault(msg, 1, 0),
intermediateCyclesList: jspb.Message.toObjectList(msg.getIntermediateCyclesList(),
    proto.runtimePackage.MonitoringCycle.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.runtimePackage.GetIntermediateCyclesResponse}
 */
proto.runtimePackage.GetIntermediateCyclesResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.runtimePackage.GetIntermediateCyclesResponse;
  return proto.runtimePackage.GetIntermediateCyclesResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.runtimePackage.GetIntermediateCyclesResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.runtimePackage.GetIntermediateCyclesResponse}
 */
proto.runtimePackage.GetIntermediateCyclesResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 2:
      var value = new proto.runtimePackage.MonitoringCycle;
      reader.readMessage(value,proto.runtimePackage.MonitoringCycle.deserializeBinaryFromReader);
      msg.addIntermediateCycles(value);
      break;
    default:
      reader.skipField();
      break;
 ...
 * @return {!Uint8Array}
 */
proto.runtimePackage.GetIntermediateCyclesResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.runtimePackage.GetIntermediateCyclesResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.runtimePackage.GetIntermediateCyclesResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.runtimePackage.GetIntermediateCyclesResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getStatusCode();
  if (f !== 0) {
    writer.writeInt32(
  ...
  f = message.getIntermediateCyclesList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
 ...
 * @return {number}
 */
proto.runtimePackage.GetIntermediateCyclesResponse.prototype.getStatusCode = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.runtimePackage.GetIntermediateCyclesResponse} returns this
 */
proto.runtimePackage.GetIntermediateCyclesResponse.prototype.setStatusCode = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};


/**
 * repeated MonitoringCycle intermediate_cycles = 2;
 * @return {!Array<!proto.runtimePackage.MonitoringCycle>}
 */
proto.runtimePackage.GetIntermediateCyclesResponse.prototype.getIntermediateCyclesList = function() {
  return /** @type{!Array<!proto.runtimePackage.MonitoringCycle>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.runtimePackage.MonitoringCycle, 2));
};
 ...
 * @return {!proto.runtimePackage.GetIntermediateCyclesResponse} returns this
*/
proto.runtimePackage.GetIntermediateCyclesResponse.prototype.setIntermediateCyclesList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 2, value);
};
 ...
 * @return {!proto.runtimePackage.MonitoringCycle}
 */
proto.runtimePackage.GetIntermediateCyclesResponse.prototype.addIntermediateCycles = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.runtimePackage.MonitoringCycle, opt_index);
};
 ...
 * @return {!proto.runtimePackage.GetIntermediateCyclesResponse} returns this
 */
proto.runtimePackage.GetIntermediateCyclesResponse.prototype.clearIntermediateCyclesList = function() {
  return this.setIntermediateCyclesList([]);
};
